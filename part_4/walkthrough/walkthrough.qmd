...
The Part 4 implementation lives in [part_4/implementation/](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/):

| File | Purpose |
|---|---|
| [certificate.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/certificate.py) | Build, sign and verify X.509 certificates and chains. |
| [setup_certificates.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/setup_certificates.py) | Generate root + intermediate + server certs to disk (run once). |
| [handshake.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/handshake.py) | X25519 key exchange + ServerAuth (cert chain + signature). |
| [key_schedule.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/key_schedule.py) | HKDF session-key derivation (carried over from Part 3 v3). |
| [record_protection.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/record_protection.py) | AES-GCM record layer (carried over from Part 3 v3). |
| [server_v4.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/server_v4.py) | Runnable server. |
| [client_v4.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/client_v4.py) | Runnable client. |
...
Two helpers in [certificate.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/certificate.py) produce the
...
[setup_certificates.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/setup_certificates.py) generates a full
...
[server_v4.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/server_v4.py) loads the long-term IDENTITY
...
[client_v4.py](https://github.com/DmytroHuzz/rebuilding_tls/blob/main/part_4/implementation/client_v4.py) is symmetric: it loads the
